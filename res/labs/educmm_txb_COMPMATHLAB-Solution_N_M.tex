...
$$
u(x)=\frac{2\left(-3 e^{21-(3 x) / 2}-5 e^{39-(3 x) / 2}-5 e^{(3 x) / 2-3}+3 e^{(3 x) / 2+15}+5+5 e^{36}\right)}{9\left(1+e^{36}\right)}.
$$
...
\int_0^L \mathbf{W_e}\left( 4\frac{d^2\mathbf{u}}{dx^2}   -9u     +10 \right) d x=0,
\end{equation}
где $\mathbf{W_e=N_e}^T$.

$$\int_0^L \mathbf{W_e}\left(4\frac{d^2\mathbf{u}}{dx^2}   -9u     +10 \right) d x = 4\int_0^L \mathbf{W_e} \frac{d^2 \mathbf{u}}{dx^2} dx    -9 \int_0^L \mathbf{W_e u} d x     +10 \int_0^L \mathbf{W_e} dx =0$$
...
$$
\begin{bmatrix}
	4\frac{1}{L}    -9 \frac{L}{3}  , &   -4 \frac{1}{L}    -9 \frac{L}{6}   \\
	  -4  \frac{1}{L}    -9 \frac{L}{6}  , &  4\frac{1}{L}    -9 \frac{L}{3}  
\end{bmatrix}
\begin{bmatrix}
	u_i \\
	u_j
\end{bmatrix}=
\begin{bmatrix}
	  -4 \frac{du}{dx}|_i   +10 \frac{L}{2} \\
	4\frac{du}{dx}|_j   +10 \frac{L}{2} 
\end{bmatrix}
$$
...
$$4 \int_0^L \mathbf{W_e} \frac{d^2 \mathbf{u}}{dx^2} dx
=
4\int_0^L
\begin{bmatrix}
	-\frac{9x^3}{2L^3}&+&\frac{18x^2}{2L^2}&-&\frac{11x}{2L} &+& 1\\
...
$$
 -9   \int_0^L \mathbf{W_e} \mathbf{u} dx
=
 -9   \int_0^L
\begin{bmatrix}
  -\frac{9x^3}{2L^3}&+&\frac{18x^2}{2L^2}&-&\frac{11x}{2L} &+& 1\\
...
$$
\begin{bmatrix}
		4\frac{37}{10L}    -9 \frac{8L}{105}   &
		  -4 \frac{189}{40L}     -9 \frac{33L}{560}   &
		4\frac{27}{20L}   +9 \frac{3L}{140}   &
		  -4 \frac{13}{40L}     -9 \frac{119L}{1680}  \\

		  -4 \frac{189}{40L}    -9 \frac{33L}{560}   &
		4\frac{54}{5L}+0  -9 \frac{27L}{170}   &
		  -4 \frac{297}{40L}   +9 \frac{27L}{560}   &
		4\frac{27}{20L}    +9 \frac{27L}{560}   \\
		...
		4\frac{54}{5L}+0  -9 \frac{27L}{170}   &
	      ...
	      -4 \frac{13}{40L}    -9 \frac{19L}{1680}   &
		4\frac{27}{20L} \frac{3}{10}  -9 \frac{3L}{140}   &
		  -4 \frac{189}{40L}   -9 \frac{33L}{560}   &
		4\frac{37}{10L}    -9 \frac{8L}{105}  
\end{bmatrix}
\cdot
...
=
\begin{bmatrix}
     10\frac{L}{8}    -4 \frac{du}{dx}|_i   \\
	 10\frac{3L}{8} \\
	 10\frac{3L}{8} \\
	 10\frac{L}{8}    +4 \frac{du}{dx}|_l 
\end{bmatrix}
\end{align}
