...
$$
u(x)=y(x)=\frac{30 e^{45}(x+75)+592 e^{(15 x) / 4}-592}{225 e^{45}}.
$$
...
\int_0^L \mathbf{W_e}\left( 12\frac{d^2\mathbf{u}}{dx^2} -45  \frac{d\mathbf{u}}{dx}  +6 \right) d x=0,
\end{equation}
где $\mathbf{W_e=N_e}^T$.

$$\int_0^L \mathbf{W_e}\left(12\frac{d^2\mathbf{u}}{dx^2} -45  \frac{du}{dx}  +6 \right) d x= 12\int_0^L \mathbf{W_e} \frac{d^2 \mathbf{u}}{dx^2} dx  -45   \int_0^L \mathbf{W_e}\frac{d\mathbf{u}}{dx} d x   +6 \int_0^L \mathbf{W_e} d x=0$$

Распишем каждое слагаемое отдельно:
$$
12\int_0^L \mathbf{W_e} \frac{d^2 \mathbf{u}}{dx^2} dx=12\int_0^L
	\begin{bmatrix}
	(1-\frac{x}{L}) \\
	\frac{x}{L}
	\end{bmatrix}
...
=
	\begin{bmatrix}
	  -12 \frac{d\mathbf{u}}{dx}|_i \\
12\frac{d\mathbf{u}}{dx}|_j
	\end{bmatrix}   -12 
\begin{bmatrix}
\frac{1}{L}, & -\frac{1}{L} \\
-\frac{1}{L}, & \frac{1}{L}
...
$$
 -45  \int_0^L \mathbf{W_e} \frac{d \mathbf{u}}{dx} dx= -45  \int_0^L
	\begin{bmatrix}
	(1-\frac{x}{L}) \\
	\frac{x}{L}
	\end{bmatrix}
...
$$
\begin{bmatrix}
	12\frac{1}{L}  -45   \frac{1}{2}, &   -12 \frac{1}{L}  +45   \frac{1}{2} \\
	  -12  \frac{1}{L} -45   \frac{1}{2}, &  12\frac{1}{L}  +45   \frac{1}{2}
\end{bmatrix}
\begin{bmatrix}
	u_i \\
...
\end{bmatrix}=
\begin{bmatrix}
	  -12 \frac{du}{dx}|_i   +6  \frac{L}{2}\\
	12\frac{du}{dx}|_j   +6  \frac{L}{2}
\end{bmatrix}
$$
...
$$12 \int_0^L \mathbf{W_e} \frac{d^2 \mathbf{u}}{dx^2} dx
=
12\int_0^L
\begin{bmatrix}
	-\frac{9x^3}{2L^3}&+&\frac{18x^2}{2L^2}&-&\frac{11x}{2L} &+& 1\\
...
$$
 -45   \int_0^L \mathbf{W_e} \frac{d \mathbf{u}}{dx} dx
=
 -45  \int_0^L
\begin{bmatrix}
  -\frac{9x^3}{2L^3}&+&\frac{18x^2}{2L^2}&-&\frac{11x}{2L} &+& 1\\
...
\begin{bmatrix}12\frac{37}{10L} -45  \frac{1}{2} &   -12 \frac{189}{40L} +45  \frac{57}{80} & 12\frac{27}{20L} -45  \frac{3}{10} &   -12 \frac{13}{40L}  +45   \frac{7}{80}\\
	  -12 \frac{189}{40L}  -45  \frac{57}{80} & 12\frac{54}{5L}+0 &   -12 \frac{297}{40L} +45  \frac{81}{80} & 12\frac{27}{20L}  -45  \frac{3}{10} \\
	12\frac{27}{20L}  +45   \frac{3}{10} &   -12 \frac{297}{40L} -45  \frac{81}{80} & 12\frac{54}{5L}+0 &   -12 \frac{189}{40L}  +45  \frac{57}{80} \\
	  -12 \frac{13}{40L}  -45  \frac{7}{80} & 12\frac{27}{20L} +45  \frac{3}{10} &   -12 \frac{189}{40L} +45  \frac{57}{80} & 12\frac{37}{10L}  +45  \frac{1}{2}
\end{bmatrix}
\begin{bmatrix}
	u_i \\
	u_j \\
...
=
\begin{bmatrix}
    6\frac{L}{8}   -12  \frac{du}{dx}|_i \\
	6\frac{3L}{8}\\
	6\frac{3L}{8}\\
	6\frac{L}{8}   +12  \frac{du}{dx}|_l
\end{bmatrix}
\end{align}
...
\end{bmatrix} =
\begin{bmatrix}
b_1   -12  \frac{du}{dx}|_i \\
b_2\\
b_3\\
b_4   +12  \frac{du}{dx}|_l
\end{bmatrix}$$
...
\end{bmatrix} =
\begin{bmatrix}
b_1^1   -12  \frac{du}{dx}|_0 \\
b_2^1+b_1^2\\
b_2^2+b_1^3\\
b_2^3+b_1^4\\
\vdots\\
b_2^{n-1}+b_1^n\\
b_2^n   +12  \frac{du}{dx}|_L
\end{bmatrix}
$$
