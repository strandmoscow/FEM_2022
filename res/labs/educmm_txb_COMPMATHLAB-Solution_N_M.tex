...
$$
u(x)=y(x)=rac{2\left(222 x+1903 e^{(37(x-3)) / 22}-1903 e^{111 / 11}+4847ight)}{1369}).
$$
...
$$\int_0^L \mathbf{W_e}\left(22\frac{d^2\mathbf{u}}{dx^2} -37  \frac{du}{dx}  +12 \right) d x= 22\int_0^L \mathbf{W_e} \frac{d^2 \mathbf{u}}{dx^2} dx  -37   \int_0^L \mathbf{W_e}\frac{d\mathbf{u}}{dx} d x   +12 \int_0^L \mathbf{W_e} d x=0$$
...
$$22 \int_0^L \mathbf{W_e} \frac{d^2 \mathbf{u}}{dx^2} dx
=
22\int_0^L
\begin{bmatrix}
	-\frac{9x^3}{2L^3}&+&\frac{18x^2}{2L^2}&-&\frac{11x}{2L} &+& 1\\
...
\begin{bmatrix}22\frac{37}{10L} -37  \frac{1}{2} &   -22 \frac{189}{40L} +37  \frac{57}{80} & 22\frac{27}{20L} -37  \frac{3}{10} &   -22 \frac{13}{40L}  +37   \frac{7}{80}\\
