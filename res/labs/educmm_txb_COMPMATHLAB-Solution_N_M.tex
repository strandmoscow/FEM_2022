...
$$
u(x)=\begin{aligned} & \frac{1}{15\left(1+e^{22 \sqrt{15}}\right)} e^{-\sqrt{15}(x+3)} \cdot \\ & \cdot \left(146 e^{2 \sqrt{15} x}+4 e^{\sqrt{15}(x+3)}+4 e^{\sqrt{15}(x+25)}+\sqrt{15} e^{\sqrt{15}(2 x+11)}-\right. \ &\left.\sqrt{15} e^{17 \sqrt{15}}+146 e^{28 \sqrt{15}}\right)\end{aligned}.
$$
