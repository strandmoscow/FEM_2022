...
$$\int_0^L \mathbf{W_e}\left({{ a_int }}\frac{d^2\mathbf{u}}{dx^2}{% if b_int < 0 %} -{{ b_abs }}\frac{du}{dx} {% endif %} {% if b_int > 0 %} +{{ b_abs }}\frac{du}{dx} {% endif %} {% if c_int < 0 %} -{{ c_abs }}u {% endif %} {% if c_int > 0 %} +{{ c_abs }}u {% endif %} {% if d_int < 0 %} -{{ d_abs }} {% endif %} {% if d_int > 0 %} +{{ d_abs }} {% endif %}\right) d x = {{ a_int }}\int_0^L \mathbf{W_e} \frac{d^2 \mathbf{u}}{dx^2} dx {% if b_int < 0 %} -{{ b_abs }} \int_0^L \mathbf{W_e}\frac{d\mathbf{u}}{dx} d x {% endif %} {% if b_int > 0 %} +{{ b_abs }} \int_0^L \mathbf{W_e}\frac{d\mathbf{u}}{dx} d x {% endif %} {% if c_int < 0 %} -{{ c_abs }} \int_0^L \mathbf{W_e u} d x {% endif %} {% if c_int > 0 %} +{{ c_abs }} \int_0^L \mathbf{W_e u} dx {% endif %} {% if d_int < 0 %} -{{ d_abs }} \int_0^L \mathbf{W_e} {% endif %} {% if d_int > 0 %} +{{ d_abs }} \int_0^L \mathbf{W_e u} {% endif %}=0$$
