...
\int_0^L \mathbf{W_e}\left( {{ a_int }}\frac{d^2\mathbf{u}}{dx^2}{% if b_int < 0 %} -{{ b_abs }} {% endif %} {% if b_int > 0 %} +{{ b_abs }} {% endif %}\frac{d\mathbf{u}}{dx} {% if c_int < 0 %} -{{ c_abs }}u {% endif %} {% if c_int > 0 %} +{{ c_abs }}u {% endif %} {% if d_int < 0 %} -{{ d_abs }} {% endif %} {% if d_int > 0 %} +{{ d_abs }} {% endif %}\right) d x=0,
\end{equation}
где $\mathbf{W_e=N_e}^T$.

$$\int_0^L \mathbf{W_e}\left({{ a_int }}\frac{d^2\mathbf{u}}{dx^2}{% if b_int < 0 %} -{{ b_abs }} {% endif %} {% if b_int > 0 %} +{{ b_abs }} {% endif %}\frac{du}{dx} {% if c_int < 0 %} -{{ c_abs }}u {% endif %} {% if c_int > 0 %} +{{ c_abs }}u {% endif %} {% if d_int < 0 %} -{{ d_abs }} {% endif %} {% if d_int > 0 %} +{{ d_abs }} {% endif %}\right) d x = {{ a_int }}\int_0^L \mathbf{W_e} \frac{d^2 \mathbf{u}}{dx^2} dx {% if b_int < 0 %} -{{ b_abs }} \int_0^L \mathbf{W_e}\frac{d\mathbf{u}}{dx} d x {% endif %} {% if b_int > 0 %} +{{ b_abs }} \int_0^L \mathbf{W_e}\frac{d\mathbf{u}}{dx} d x {% endif %} {% if c_int < 0 %} -{{ c_abs }} \int_0^L \mathbf{W_e u} d x {% endif %} {% if c_int > 0 %} +{{ c_abs }} \int_0^L \mathbf{W_e u} dx {% endif %} {% if d_int < 0 %} -{{ d_abs }} \int_0^L \mathbf{W_e} {% endif %} {% if d_int > 0 %} +{{ d_abs }} \int_0^L \mathbf{W_e u} {% endif %}=0$$
...
\begin{bmatrix}
		...
		{{ a_int }}\frac{27}{20L}{% if b_int < 0 %} -{{ b_abs }} \frac{3}{10} {% endif %} {% if b_int > 0 %} +{{ b_abs }} \frac{3}{10} {% endif %} {% if c_int < 0 %} -{{ c_abs }} \frac{8L}{105} {% endif %} {% if c_int > 0 %} +{{ c_abs }} \frac{8L}{105} {% endif %} {% if c_int < 0 %} +{{ c_abs }} \frac{3L}{140} {% endif %} {% if c_int > 0 %} -{{ c_abs }} \frac{3L}{140} {% endif %} &
		{% if a_int < 0 %} {{ a_abs }} \frac{13}{40L} {% endif %} {% if a_int > 0 %} -{{ a_abs }} \frac{13}{40L} {% endif %} {% if b_int < 0 %} +{{ b_abs }} {% endif %} {% if b_int > 0 %} -{{ b_abs }} {% endif %} \frac{7}{80} {% if c_int < 0 %} -{{ c_abs }} \frac{119L}{1680} {% endif %} {% if c_int > 0 %} +{{ c_abs }} \frac{119L}{1680} {% endif %}\\

		{% if a_int < 0 %} {{ a_abs }} {% endif %} {% if a_int > 0 %} -{{ a_abs }} {% endif %}\frac{189}{40L} {% if b_int < 0 %} -{{ b_abs }} {% endif %} {% if b_int > 0 %} +{{ b_abs }} {% endif %}\frac{57}{80} {% if c_int < 0 %} -{{ c_abs }} \frac{33L}{560} {% endif %} {% if c_int > 0 %} +{{ c_abs }} \frac{33L}{560} {% endif %} &
		{{ a_int }}\frac{54}{5L}+0 {% if c_int < 0 %} -{{ c_abs }} \frac{27L}{170} {% endif %} {% if c_int > 0 %} +{{ c_abs }} \frac{27L}{170} {% endif %} &
		{% if a_int < 0 %} {{ a_abs }} {% endif %} {% if a_int > 0 %} -{{ a_abs }} {% endif %}\frac{297}{40L}{% if b_int < 0 %} +{{ b_abs }} {% endif %} {% if b_int > 0 %} -{{ b_abs }} {% endif %}\frac{81}{80} {% if c_int < 0 %} +{{ c_abs }} \frac{27L}{560} {% endif %} {% if c_int > 0 %} -{{ c_abs }} \frac{27L}{560} {% endif %} &
		...
		{% if a_int < 0 %} {{ a_abs }} {% endif %} {% if a_int > 0 %} -{{ a_abs }} {% endif %}\frac{189}{40L}{% if b_int < 0 %} +{{ b_abs }} {% endif %} {% if b_int > 0 %} -{{ b_abs }} {% endif %}\frac{57}{80} {% if c_int < 0 %} -{{ c_abs }} \frac{33L}{560} {% endif %} {% if c_int > 0 %} +{{ c_abs }} \frac{33L}{560} {% endif %} &
		{{ a_int }}\frac{37}{10L} {% if b_int < 0 %} +{{ b_abs }} {% endif %} {% if b_int > 0 %} -{{ b_abs }} {% endif %}\frac{1}{2} {% if c_int < 0 %} -{{ c_abs }} \frac{8L}{105} {% endif %} {% if c_int > 0 %} +{{ c_abs }} \frac{8L}{105} {% endif %}
\end{bmatrix}
\cdot
$$
